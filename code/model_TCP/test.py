...
weight_path = '/data/local_userdata/tianxinyu/CVPR_2023/Models_distribution/model_TCP/'
save_path = '/data/local_userdata/tianxinyu/CVPR_2023/metric_distribution/model_TCP/'
...
for dataset in test_datasets:
    ...
    for i, (image, gt, HH, WW, name) in enumerate(tqdm(test_loader)):
        ...
        pred_tcp = F.upsample(pred_tcp, size=[HH, WW], mode='bilinear', align_corners=False)
