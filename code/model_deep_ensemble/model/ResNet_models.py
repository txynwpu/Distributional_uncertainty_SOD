...
class Pred_endecoder(nn.Module):
    ...
    def __init__(self, channel):
        ...
        self.decoder1 = Pred_decoder(channel)
        self.decoder2 = Pred_decoder(channel)
        self.decoder3 = Pred_decoder(channel)
        self.decoder4 = Pred_decoder(channel)
        self.decoder5 = Pred_decoder(channel)
    ...
    def forward(self, x):
        ...
        pred1 = self.decoder1(x1, x2, x3, x4)
        pred2 = self.decoder2(x1, x2, x3, x4)
        pred3 = self.decoder3(x1, x2, x3, x4)
        pred4 = self.decoder4(x1, x2, x3, x4)
        pred5 = self.decoder5(x1, x2, x3, x4)
