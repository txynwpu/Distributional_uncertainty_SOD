...
class Pred_endecoder(nn.Module):
    ...
    def __init__(self, channel):
        ...
        self.decoder = Pred_decoder(channel)
...
class Pred_decoder(nn.Module):
    ...
    def forward(self, x1, x2, x3, x4):
        ...
        conv1_feat = self.br1(self.conv1(self.dropout(x1)))
        conv2_feat = self.br2(self.conv2(self.dropout(x2)))
        conv3_feat = self.br3(self.conv3(self.dropout(x3)))
        conv4_feat = self.br4(self.conv4(self.dropout(x4)))
