...
save_path = '/data/local_userdata/tianxinyu/CVPR_2023/Models_distribution/model_COTTA_DUTS_structure_2epoch/'
...
for epoch in range(1, (opt.epoch+1)):
    ...
    for dataset in ['DUTS_Test', 'ECSSD', 'DUT']:
        ...
        image_root = '/data/local_userdata/tianxinyu/CVPR2022_multi-label-dataset/test/img/' + dataset + '/'
        gt_root = '/data/local_userdata/tianxinyu/CVPR2022_multi-label-dataset/test/gt/' + dataset + '/'
    ...
    # print('Generator Learning Rate: {}'.format(generator_optimizer.param_groups[0]['lr']))
        for i, pack in enumerate(train_loader, start=1):
            for rate in size_rates:
                ...
                pred, loss_all = generator(images)
