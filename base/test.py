...
weight_path = '/data/local_userdata/tianxinyu/CVPR_2023/Models_distribution/base/'

save_path = '/data/local_userdata/tianxinyu/CVPR_2023/metric_distribution/base/'
